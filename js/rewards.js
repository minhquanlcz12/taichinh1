const RewardsModule = {
    ...
    confirmRescue: async (recordId, targetUsername) => {
        ...
        if (record) {
            record.isUsed = true;
            record.usedAt = Date.now();
            record.rescueTarget = normalizedTarget;
            await RewardsModule.saveData(allRewards);
        }
