                ...
                html += `
                    <div class="glass-card prompt-card" style="padding: 16px; border-left: 4px solid var(--primary); display: flex; flex-direction: column; gap: 12px; height: 100%;">
                        <div>
                            ...
                            ${p.imgData ? `<img src="${p.imgData}" style="width:100%;max-height:140px;object-fit:contain;border-radius:6px;margin-top:10px;border:1px solid rgba(255,255,255,0.08);background:rgba(0,0,0,0.2); transition: all 0.3s ease; position: relative; z-index: 1; cursor: zoom-in;" onmouseover="this.style.transform='scale(2) translate(-10%, 10%)'; this.style.transformOrigin='top right'; this.style.zIndex='100'; this.style.boxShadow='-10px 10px 30px rgba(0,0,0,0.9)';" onmouseout="this.style.transform='scale(1) translate(0, 0)'; this.style.zIndex='1'; this.style.boxShadow='none';">` : ''}
                        </div>
